        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center my-[120px]">
          ...
          <motion.div className="space-y-8 text-center lg:text-left" variants={containerVariants} initial="hidden" animate="visible">
            <div className="space-y-4">
              ...
              duration: 0.6
            }} className="font-display sm:text-5xl lg:text-6xl xl:text-7xl text-primary-foreground leading-tight py-[10px] text-5xl">
                VĂN TRUNG
                <span className="block text-primary py-[20px] text-5xl">THIẾT BỊ
XÂY DỰNG</span>
              </motion.h1>
              <motion.p variants={itemVariants} transition={{
              duration: 0.6
            }} className="text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0">Chuyên cho thuê, mua bán, sửa chữa và bảo trì các thiết bị máy móc xây dựng: máy đục bê tông, máy tời, máy phát điện,...và các thiết bị xây dựng khác trong công trình</motion.p>
            </div>
