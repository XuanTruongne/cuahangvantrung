...
const services = [
  {
    ...
    features: [
      ...
      "Giá ưu đãi cho hợp đồng dài hạn",
      "Giao nhận tận nơi miễn phí",
      "Hỗ trợ kỹ thuật 24/7",
      "Bảo hiểm thiết bị đầy đủ",
      "Thay thế ngay khi có sự cố",
    ],
    color: "bg-blue-500",
  },
  {
    ...
    features: [
      "Thiết bị mới chính hãng",
      "Thiết bị đã qua sử dụng được kiểm định",
  ...
  },
  {
    ...
    features: [
      "Báo giá miễn phí",
      "Sửa chữa tại chỗ hoặc tại xưởng",
